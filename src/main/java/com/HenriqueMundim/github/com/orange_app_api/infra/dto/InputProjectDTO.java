...
public class InputProjectDTO {
	...
	public InputProjectDTO() {}
	
	public InputProjectDTO(Integer id, String title, String link, String description, String imageUrl, OutputUserDTO author, Set<Category> categories) {
		this.id = id;
		this.title = title;
		this.link = link;
